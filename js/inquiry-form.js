    ...
    if (!overlay) {
      ...
      overlay.innerHTML = `
        <div class="flex flex-col items-center justify-center p-6 sm:p-10 text-center max-w-xl w-full mx-auto">
            <div class="mb-4">
                <div class="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-emerald-600 text-white text-[11px] font-extrabold tracking-widest uppercase shadow-md mb-3">
                    <span>SUBMITTED</span>
                </div>
                <h2 class="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight" style="font-family:'Outfit', sans-serif;">
                    Thank <span style="color:#6366f1;">You!</span>
                </h2>
            </div>

            <!-- EXACT SELFMADESYSTEM ANIMATED LOADER -->
            <div class="loader flex items-center justify-center scale-125 sm:scale-150 my-6">
